# 1. Import a CSV file of food delivery orders into a new SQL table named FoodOrders.
...
# 2. Create TopSongs and insert at least 5 popular tracks.
...
# 4. Generate a restaurant performance report.
...
# 5. Calculate two KPIs for dashboard display.
